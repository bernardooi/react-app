    ...
    <View style={styles.contain}>
        <View >
            <TouchableOpacity onPress={() => navigation.navigate("HTML")}>
                <View style={styles.box}><Text>HTML</Text></View>
            </TouchableOpacity>
        </View>
        <View >
            <TouchableOpacity onPress={() => navigation.navigate("CSS")}>
                <View style={styles.box}><Text>CSS</Text></View>
            </TouchableOpacity>
        </View>
        <View>
            <TouchableOpacity onPress={() => navigation.navigate("JS")}>
                <View style={styles.box}><Text>JS</Text></View>
            </TouchableOpacity>
        </View>
        <View >
            <TouchableOpacity onPress={() => navigation.navigate("React")}>
                <View style={styles.box}><Text>React</Text></View>
            </TouchableOpacity>
        </View>
    </View>
